...
def test_cnn_correctness_once(idx):
    ...
    # print(dx)
    # print(dx1)
    # max_error = np.unravel_index(np.argmax(abs(dx - dx1)), dx.shape)
    # print(dx.shape, dx1.shape)
    # print("Max Error Location:", max_error)
    # print("Max Error", delta_res_norm)
